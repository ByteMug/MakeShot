...
public class ExportToolbar extends JToolBar {
	...
	ActionListener copyAction = new ActionListener(new ImageIcon(
			ExportToolbar.class.getResource("/net/makeshot/imageEditor/additional/copy.png")), "copy");
	ActionListener faceAction = new ActionListener(new ImageIcon(
			ExportToolbar.class.getResource("/net/makeshot/imageEditor/additional/facebook.png")), "fb");
	ActionListener gplusAction = new ActionListener(new ImageIcon(
			ExportToolbar.class.getResource("/net/makeshot/imageEditor/additional/google.png")), "g+");
	ActionListener printAction = new ActionListener(new ImageIcon(
			ExportToolbar.class.getResource("/net/makeshot/imageEditor/additional/print.png")), "print");

	ActionListener redditAction = new ActionListener(new ImageIcon(
			ExportToolbar.class.getResource("/net/makeshot/imageEditor/additional/reddit.png")), "reddit");
	ActionListener saveAction = new ActionListener(new ImageIcon(
			ExportToolbar.class.getResource("/net/makeshot/imageEditor/additional/save.png")), "save");
	ActionListener twittAction = new ActionListener(new ImageIcon(
			ExportToolbar.class.getResource("/net/makeshot/imageEditor/additional/twitter.png")), "twitter");
	ActionListener undoAction = new ActionListener(new ImageIcon(
			ExportToolbar.class.getResource("/net/makeshot/imageEditor/additional/upload.png")), "upload");
