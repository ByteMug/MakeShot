...
public class DrawSettingsToolbar extends JToolBar {
	...
	ActionListener colorAction = new ActionListener(new ImageIcon(
			DrawSettingsToolbar.class
					.getResource("/net/makeshot/imageEditor/additional/palette.png")), "palette");
	ActionListener eraseAction = new ActionListener(new ImageIcon(
			DrawSettingsToolbar.class
					.getResource("/net/makeshot/imageEditor/tools/box/eraser.png")), "eraser");
	ActionListener paletteAction = new ActionListener(new ImageIcon(
			DrawSettingsToolbar.class
					.getResource("/net/makeshot/imageEditor/additional/pipette.png")), "pipette");
	ActionListener text = new ActionListener(null, "textField");
	public final static JCheckBox chckbxFillRectoval = new JCheckBox(
			"Fill rect/oval");

	public DrawSettingsToolbar() {
		...
		pickerBtn.setIcon(new ImageIcon(DrawSettingsToolbar.class
				.getResource("/net/makeshot/imageEditor/additional/pipette.png")));
